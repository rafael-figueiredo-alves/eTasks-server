...
namespace eTasks_server.Models.DTOs.Readings.Requests
{
    ...
    {
        /// <summary>
        /// Título da leitura. Este campo é obrigatório e não pode ser vazio.
        /// </summary>
        ...
        /// <summary>
        /// Total de páginas da leitura. Campo obrigatório.
        /// </summary>
        ...
        /// <summary>
        /// Formato da leitura. Campo obrigatório.
        /// </summary>
        public ReadingFormat Format { get; set; } = ReadingFormat.Book;
        
        /// <summary>
        /// Status da leitura. Campo obrigatório.
        /// </summary>
